...
public class PageableParameterBuilderPlugin implements OperationBuilderPlugin {
   ...
   * @param resolver a {@link TypeResolver} object.
   */
  ...
  /**
   * Page name may be varied. See {@link org.springframework.data.web.PageableHandlerMethodArgumentResolver#setPageParameterName(String)}
   *
  ...
  /**
   * Size name may be varied. See {@link org.springframework.data.web.PageableHandlerMethodArgumentResolver#setSizeParameterName(String)}
   *
  ...
  /**
   * Sort name may be varied. See {@link org.springframework.data.web.SortHandlerMethodArgumentResolver#setSortParameter(String)}
   *
  ...
  /**
   * Create a sort parameter. Override it if needed. Set a default value or further description for
   * example.
   *
   * @param context {@link Pageable} parameter context
  ...
  protected Parameter createSortParameter(ParameterContext context) {
    ModelReference stringModel = createModelRefFactory(context)
        .apply(resolver.resolve(List.class, String.class));
    return new ParameterBuilder()
        .name(getSortName())
   ...
   */
  protected Function<ResolvedType, ? extends ModelReference> createModelRefFactory(
    ...
    return (Function<ResolvedType, ? extends ModelReference>) modelRefFactory(modelContext,
        nameExtractor);
  }
