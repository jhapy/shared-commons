 ...
 * <p>
 * This class is responsible for generating cache keys that are specific to a version of the
 * application by prefixing them with git commit hash.
 * </p>
 * <p>
 * This allows multiple versions of an application to "share" the same distributed cache even when
 * the structure of the values has changed between those versions of the software.
 * </p>
 * <p>
...
public class PrefixedKeyGenerator implements KeyGenerator {
  ...
  private String generatePrefix(GitProperties gitProperties, BuildProperties buildProperties) {
    ...
    Object p = ObjectUtils
        .firstNonNull(shortCommitId, time, version, RandomStringUtils.randomAlphanumeric(12));
