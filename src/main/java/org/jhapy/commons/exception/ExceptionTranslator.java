...
import org.jhapy.commons.config.JHapyConstants;
import org.jhapy.commons.utils.HeaderUtil;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
  ...
  public ResponseEntity<Problem> process(@Nullable ResponseEntity<Problem> entity,
    ...
    var requestUri = nativeRequest != null ? nativeRequest.getRequestURI() : StringUtils.EMPTY;
    var builder = Problem
        .builder()
  ...
  public ResponseEntity<Problem> handleBadRequestAlertException(BadRequestAlertException ex,
    ...
    return create(
        ...
        request,
        HeaderUtil
            .createFailureAlert(applicationName, false, ex.getEntityName(), ex.getErrorKey(),
                ex.getMessage())
    );
  }
  ...
  public ResponseEntity<Problem> handleConcurrencyFailure(ConcurrencyFailureException ex,
      NativeWebRequest request) {
    var problem = Problem.builder().withStatus(Status.CONFLICT)
  ...
  public ProblemBuilder prepare(final Throwable throwable, final StatusType status,
    ...
    if (activeProfiles.contains(JHapyConstants.SPRING_PROFILE_PRODUCTION)) {
  ...
  private boolean containsPackageName(String message) {
    ...
    return StringUtils
        .containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.");
  }
}
