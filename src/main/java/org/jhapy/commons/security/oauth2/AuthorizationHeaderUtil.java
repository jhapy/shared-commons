...
public class AuthorizationHeaderUtil {
  ...
  public Optional<String> getAuthorizationHeader() {
    return getAuthorizationHeader(SecurityContextHolder.getContext().getAuthentication());
  }
  ...
  private OAuth2AccessTokenResponse refreshTokenClient(OAuth2AuthorizedClient currentClient) {
    ...
    formParameters
        .add(OAuth2ParameterNames.GRANT_TYPE, AuthorizationGrantType.REFRESH_TOKEN.getValue());
    formParameters
        .add(OAuth2ParameterNames.REFRESH_TOKEN, currentClient.getRefreshToken().getTokenValue());
    formParameters
        .add(OAuth2ParameterNames.CLIENT_ID, currentClient.getClientRegistration().getClientId());
